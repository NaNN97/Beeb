...
var grammar = {
    ...
    {"name": "boolean", "symbols": [(myLexer.has("boolean_true") ? {type: "boolean_true"} : boolean_true)], "postprocess": d => true},
    {"name": "boolean", "symbols": [(myLexer.has("boolean_flase") ? {type: "boolean_flase"} : boolean_flase)], "postprocess": d => false},
